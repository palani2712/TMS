    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between w-full p-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 z-30 sticky top-0">
        <div className="flex items-center h-12">
          <img src={darkMode ? '/logo-dark-cs.png' : '/logo-light-cs.png'} alt="CSHR Logo" className="h-12 w-auto object-contain" />
        </div>
        <button 
      ...
      <aside className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 w-64 lg:static lg:flex flex-col glass dark:bg-slate-900/90 border-r h-full max-h-screen text-[var(--color-text-main)]`}>
        ...
        <div className="pt-2 pb-2 px-6 border-b border-slate-400 dark:border-slate-700/80 flex items-center justify-between gap-4">
          <div className="flex items-center h-fit max-w-[150px] w-full">
            <img src={darkMode ? '/logo-dark-cs.png' : '/logo-light-cs.png'} alt="CSHR Logo" className="w-full h-auto object-contain" />
          </div>
          <div className="flex items-center gap-2">
            <button 
              onClick={toggleTheme}
              className="p-2 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-900 dark:border-slate-700 transition-colors"
              title="Toggle theme"
            >
            ...
            <div className="relative">
              <button
                ...
                className="p-2 rounded-xl bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 border border-slate-900 dark:border-slate-700 transition-colors relative"
                title="Notifications"
              >
