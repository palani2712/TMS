                ...
                {user?.role === 'ROLE_INTERN' ? (
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      disabled
                      className="w-full px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-100/50 dark:bg-slate-900/50 text-slate-500 cursor-not-allowed text-sm focus:outline-none"
                    />
                  </div>
                ) : (
                  <>
                    <div>
                      ...
                      >
                        {user?.role === 'ROLE_ADMIN' && <option className="bg-[var(--color-bg-card)] text-[var(--color-text-main)] dark:bg-slate-900 dark:text-slate-200" value="ROLE_ADMIN">General Manager</option>}
                        {(user?.role === 'ROLE_ADMIN' || user?.role === 'ROLE_MANAGER') && <option className="bg-[var(--color-bg-card)] text-[var(--color-text-main)] dark:bg-slate-900 dark:text-slate-200" value="ROLE_MANAGER">Manager</option>}
                        {(user?.role === 'ROLE_ADMIN' || user?.role === 'ROLE_MANAGER' || user?.role === 'ROLE_EMPLOYEE') && <option className="bg-[var(--color-bg-card)] text-[var(--color-text-main)] dark:bg-slate-900 dark:text-slate-200" value="ROLE_EMPLOYEE">Employee</option>}
