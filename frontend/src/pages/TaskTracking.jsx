...
const TaskTracking = () => {
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      ...
      case 'ON_HOLD': return 'bg-amber-100 text-amber-850 dark:bg-amber-955/45 dark:text-amber-300 border-amber-200 dark:border-amber-900/30';
      default: return '';
    }
  };
              ...
              >
                ...
                {isExpanded && (() => {
                  ...
                  const filteredUserTasks = item.tasks.filter(task => {
                    ...
                    const dateField = userFilter.dateFilterType === 'CREATED_DATE' ? 'createdDate' : 'dueDate';
