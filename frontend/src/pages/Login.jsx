  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#DAD8C9]">
      ...
      <div className="w-full max-w-md mx-4 z-10">
        <div className="bg-[#363636] backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/10 text-white flex flex-col items-center">
          
          <img src="/logo-cs.png" alt="Career School HR Solutions" className="w-72 h-auto object-contain mb-[-12px] mt-0" />
